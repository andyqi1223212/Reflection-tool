...
# DeepSeek OpenAI 兼容端点与模型（须在 load_environment() 之后读取 os.environ）：
# - 首次调用 / base_url: https://api-docs.deepseek.com/zh-cn/
# - JSON Output + deepseek-v4-pro: https://api-docs.deepseek.com/zh-cn/guides/json_mode
# 旧名 deepseek-chat / deepseek-reasoner 将于 2026-07-24 弃用，分别对应 v4-flash 非思考 / 思考模式；
# 本仓库默认推理用 deepseek-v4-pro（思考模式），默认对话用 deepseek-v4-flash。
DEEPSEEK_OPENAI_BASE_URL = os.getenv("DEEPSEEK_OPENAI_BASE_URL", "https://api.deepseek.com")
DEEPSEEK_DEFAULT_MODEL = os.getenv("DEEPSEEK_MODEL", "deepseek-v4-pro")
DEEPSEEK_DEFAULT_CHAT_MODEL = os.getenv("DEEPSEEK_CHAT_MODEL", "deepseek-v4-flash")


def _deepseek_v4_pro_thinking_kwargs(model: str) -> dict:
    """deepseek-v4-pro 在官方示例中与 thinking + reasoning_effort 联用。"""
